...
Sections 8.6 to 8.13 of `SPEC.md`, one file per subsection. Each is a run plan
...
| [8.13](8.13-pre-registered-m2-11-sampling-grid.md) | M2.11 sampling grid | 2x2 sampler factorial, 98 dates | pending |
