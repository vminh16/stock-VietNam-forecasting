...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `small_l40` | 40 | 40 | 49.9963 | 48.5194 | 0.0117 | 53.4694 | 0.025328 | 0.3385 | 0.042821 |
| `small_l40_norm126` | 40 | 126 | 50.5621 | 49.1236 | 0.0221 | 53.6735 | 0.025599 | 0.3738 | 0.047458 |

## Runtime

| arm | origins | seconds | origins/s | peak VRAM GB |
|---|---:|---:|---:|---:|
| `small_l40` | 13,431 | 1012.1 | 13.27 | 0.14 |
| `small_l40_norm126` | 13,431 | 1017.3 | 13.20 | 0.14 |

## How To Read The Arms

- `small_l63` versus `small_l126` mixes context length with the normalization
  scale, because `L` sets both.
- `small_l63_norm126` holds the 40-session rows but borrows
